...
public class AddClientCommand implements CommandWithValidation {
    ...
    public void onSuccess(HttpServletRequest request, HttpServletResponse response) throws CommandException {
        try {
            String params = "/car_rental?command=to_clients_list";//стр со списком клиентов
    ...
    public void onValidationError(HttpServletRequest request, HttpServletResponse response, String feedback) throws CommandException {
        try {
            ...
            request.getRequestDispatcher(PagePath.SERVLET + "/car_rental?command=to_add_client").forward(request, response);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws CommandException {
        ...
        ClientValidator validator = new ClientValidator(); //проверка подлинности данных
        ...
        try {
            new SqlRepository<Client>(new ClientBinding()).addEntity(client);//добавление клиента в бд
