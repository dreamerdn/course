        ...
        <form action="<c:url value="/car_rental"/>" method="POST" class="needs-validation action-form"
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Модель" required maxlength="50"
                           id="model"
                           name="model">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" placeholder="ID" required
                           min="1" max="99"
                           id="make_id"
                           name="make_id">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Регистрационный номер" required maxlength="50"
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" placeholder="Год" required
                           min="1900" max="2099"
                           id="year"
                           name="year">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" placeholder="Пробег" required
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" placeholder="Тип коробки передач" required
                           min="1" max="2" step="1"
                           id="gearbox_type"
                           name="gearbox_type">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" placeholder="Цена за день" required
                           min="0" max="100000" step="7.01"
                           id="price_per_day"
                           name="price_per_day">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" placeholder="Цена за день (>7 дней)" required
                           min="0" max="100000" step="7.01"
                           id="price_per_day_2"
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-light">Добавить машину</button>
            </div>
        </form>
    </div>
</div>
