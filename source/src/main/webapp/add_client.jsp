        ...
        <form action="<c:url value="/car_rental"/>" method="POST" class="needs-validation action-form"
            ...
            <div class="form-group">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Фамилия" required maxlength="50"
                           id="surname"
                           name="surname">
                </div>
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Имя" required maxlength="50"
                           id="name"
                           name="name">
                </div>
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Отчество" required maxlength="50"
                           id="patronymic"
                           name="patronymic">
                </div>
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="№ паспорта" aria-label="№ паспорта"
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="tel" class="form-control" placeholder="Дом. тел." minlength="5"
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="tel" class="form-control" placeholder="Моб. тел." minlength="5" maxlength="20"
                           id="mobile_phone"
                           name="mobile_phone">
                </div>
                <div class="input-group mb-3">
                    ...
                    <input type="email" class="form-control" placeholder="E-mail" minlength="5" maxlength="50"
                           id="email"
                           name="email">
                </div>
            </div>
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-light">Добавить клиента</button>
            </div>
        </form>
    </div>
</div>
